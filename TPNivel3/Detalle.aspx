...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-around mt-xxl-5 p-xxl-5" style="margin: 200px; margin-bottom: 100px; background-color: white;">
        <div>
    ...
    <asp:Button Text="Volver al Catálogo" ID="btnVolver" CssClass="btn btn-primary d-block mx-auto mt-xxl-5 mb-xxl-5" OnClick="btnVolver_Click" runat="server" />
